...
const PrivacyPolicy = () => {
  return (
    <div className="body">
          ...
          <strong>
            <span style={{ fontSize: 15 }}>
              <span className="subtitle">
                Last updated <span className="question">November 18, 2024</span>
              </span>
            </span>
          </strong>
        </span>
          ...
          <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
            <span className="body_text">
              ...
              <span className="question">
                ...
                <span className="question">Flair Health</span>)
                <span className="statement-end-if-in-editor" />
              </span>{" "}
      ...
      <ul>
        <li className="body_text" style={{ lineHeight: "1.5" }}>
            ...
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span className="body_text">
                ...
                <span style={{ color: "rgb(0, 58, 250)" }}>
                  <span className="question">
                    <a
                      href="https://flairhealth.com"
                      target="_blank"
                      className="link"
                    >
                      https://flairhealth.com
                    </a>
                  </span>
                </span>
                <span style={{ fontSize: 15 }}>
          ...
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span className="body_text">
                ...
                <span className="block-component" /> (
                <span className="question">
                  Flair Health Specialty Medication Support)
                  <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                    <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                      <span className="body_text">
                        <span style={{ fontSize: 15 }}>
      ...
      <ul>
        <li className="body_text" style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15 }}>
            Use{" "}
            <span className="question">
              Flair Health Specialty Medication Denial
            </span>
            .{" "}
            <span className="question">
              Flair Health is an innovative healthcare startup backed by Y
              Combinator, developing AI-powered tools to streamline healthcare
              workflows. We are building solutions to tackle inefficiencies in
              specialty medication claims, with a focus on denials management.
            </span>
          </span>
          <span className="statement-end-if-in-editor">
            <span style={{ fontSize: 15 }} />
        ...
        <span style={{ fontSize: 15 }}>
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span className="body_text">
              ...
              <span className="question">hello@flairhealth.com</span>.
            </span>
          </span>
        </span>
      </div>
      ...
      <div style={{ lineHeight: "1.5" }}>
        ...
        <a className="link" href="#sensitiveinfo">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span className="body_text">sensitive information we process</span>
          </span>
        </a>
        <span className="body_text">.</span>
        <span style={{ fontSize: 15 }}>
      ...
      <div style={{ lineHeight: "1.5" }}>
        ...
        <a className="link" href="#othersources">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span className="body_text">
      ...
      <div style={{ lineHeight: "1.5" }}>
        ...
        <a
          className="link"
          href="https://app.termly.io/notify/009294e3-8887-4272-b739-ef965e166890"
          ...
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span className="body_text">
                <span style={{ fontSize: 15 }}>
                  <span className="body_text">
                    <span className="question">insurance information</span>
                  </span>
                </span>
              </span>
            </span>
          ...
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span className="body_text">
                <span style={{ fontSize: 15 }}>
                  <span className="body_text">
                    <span className="question">denial information</span>
                  </span>
                </span>
              </span>
            </span>
      ...
      <ul>
        <li className="body_text" style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: 15 }}>
            <span className="body_text">
              <span className="question">health data</span>
            </span>
          </span>
        </li>
      </ul>
          ...
          <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
              <span className="body_text">
                ...
                reports (sometimes called <span className="block-component" />
                "crash dumps"
                <span className="statement-end-if-in-editor" />
