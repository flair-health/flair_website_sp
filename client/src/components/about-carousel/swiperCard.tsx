...
const SwiperCard = ({
  ...
  return (
    <div className="flex justify-center flex-col md:flex-row gap-4 p-8">
      <div className="border-[0.5px] p-8 rounded-3xl glass-card text-black max-w-[400px] md:min-h-[450px]">
      ...
      <div className="md:flex-col gap-4 hidden md:flex">
        <div className="border-[0.5px] max-w-[300px] p-8 text-sm text-gray-400 rounded-3xl glass-card min-h-[220px]">
